...
adouble Vd_eqn(adouble& phi, adouble& V, adouble& phid, adouble& delta) {
...
adouble phidd_eqn(adouble& phi, adouble& V, adouble& phid, adouble& delta) {
  /*
...
{
    return  controls[0] * controls[0] + controls[1] * controls[1] + controls[2] * controls[2]; // Squared torque front, rear, and steer acceleration.
}
         ...
         adouble* xad, int iphase, Workspace* workspace)
{
   ...
   derivatives[0] = phid;
   derivatives[1] = Vd_eqn(phi, V, phid, delta); 
   derivatives[2] = phidd_eqn(phi, V, phid, delta); 
...
////////////////////////////////////////////////////////////////////////////
    ...
    problem.phases(1).bounds.lower.states(2) = -5.0; // phid
    problem.phases(1).bounds.lower.states(3) = -1.57; // delta
    problem.phases(1).bounds.lower.states(4) = -5.0; // deltad
    ...
    problem.phases(1).bounds.lower.controls(1) = -30.0; // deltadd
    ...
    problem.phases(1).bounds.lower.events(14) = 6.0;
...
////////////////////////////////////////////////////////////////////////////
    ...
    x0 <<  linspace(0.0, 0.0, 40), // phi
           linspace(2.0, 0.0, 40), // V
           linspace(0.0, 0.0, 40), // phid
           linspace(0.0, 1.0, 40), // delta
           linspace(0.0, 0.0, 40), // deltad
           linspace(0.0, 0.0, 40), // yaw
           linspace(0.0, 6.0, 40), // xr
           linspace(0.0, 0.0, 40); // yr

    problem.phases(1).guess.controls       = zeros(3, 40);
